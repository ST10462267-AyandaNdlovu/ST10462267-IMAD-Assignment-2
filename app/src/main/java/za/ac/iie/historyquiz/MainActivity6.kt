...
class MainActivity6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textView = findViewById<TextView>(R.id.flashCard5)
        val falseButton = findViewById<Button>(R.id.buttonFalse5)
        val trueButton = findViewById<Button>(R.id.buttonTrue5)
