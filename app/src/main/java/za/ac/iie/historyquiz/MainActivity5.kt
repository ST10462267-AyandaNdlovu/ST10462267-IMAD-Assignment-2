...
class MainActivity5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textView = findViewById<TextView>(R.id.flashCard4)
        val falseButton = findViewById<Button>(R.id.buttonFalse4)
        val trueButton = findViewById<Button>(R.id.buttonTrue4)

        val correctAnswer = false
        val currentScore = intent.getIntExtra("score", 0) // Get score from MainActivity4
